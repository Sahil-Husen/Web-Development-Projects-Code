...
function showWeaterReport(weather) {
    ...
    `;
        ...
        reset();
// yaha dynamic text ko style kiya gaya h
        weather_body.querySelector('.location-deatils').style.fontSize  ='50px';
        weather_body.querySelector('.location-deatils').style.color  ='white';
        weather_body.querySelector('.city').style.fontWeight = 'bold';
        weather_body.querySelector('.weather-status').style.color ='white'
        weather_body.querySelector('.weather-status').style.fontSize  ='30px';
        weather_body.querySelector('.day-details').style.color = 'white';
        weather_body.querySelector('.day-details').style.fontSize = '40px';
    }
